...
def load_embedding_model(embedding_model_name: str):
    if embedding_model_name == "openai":
        ...
        try:
            # Try to load HuggingFace embeddings with cache support
            import os
            from pathlib import Path
            ...
            logging.warning(f"Failed to load HuggingFace embeddings: {e}")
            logging.info("Falling back to simple embedding placeholder...")
